        ...
        <div class="page-content d-flex align-items-stretch">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#pagesDropdown" aria-expanded="false" data-toggle="collapse"> <i><img src="<?php echo base_url(); ?>dasboard/icon/dasboard.png"></i>Informasi</a>
                        <ul id="pagesDropdown" class="collapse list-unstyled ">
                            <li><a href="pesanan">Keranjang</a></li>
            ...
            <div class="content-inner">
                ...
                <header class="page-header">
                    <div class="container-fluid">
                        <h2 class="no-margin-bottom">Data Keranjang</h2>
                    </div>
                </header>
                <!-- Breadcrumb-->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <button type="submit"><?php echo anchor('pesanan/reset/', 'pesan ulang'); ?></button><br>
                                    <table border="1" style="width: 100%;" class="table">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo number_format($p['harga_p'], 2, ',', '.'); ?></td>

                                                <Rp. <?php echo number_format($p['harga_p'], 2, ',', '.'); ?>></Rp.>
                                                <input type="hidden" name="nama" value="<?php echo $p['nama_p']; ?>">
                                                <input type="hidden" name="harga" value="<?php echo $p['harga_p']; ?>">
                                        ...
                                        <tr>
                                        <td><input type="hidden" name="id" value="">Total Harga</td>
                                        <td><input type="hidden" name="nama" value="<?php echo $this->session->userdata("nama") ?>"></td>
                                        <td><input type="hidden" name="harga" value="<?php echo $total ?>"><?php echo number_format($total, 2,',','.'); ?></td>
