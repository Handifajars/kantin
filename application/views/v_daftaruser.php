						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="table-responsive">
									<button type="submit"><?php echo anchor('crud/user/handi/17081010012', 'Tambah'); ?></button>
									<table border="1" style="width: 100%;" class="table">
										...
										foreach ($m_data as $p) { ?>
											<tr>
												...
												<td><?php echo anchor('crud/edituser/handi/17081010012/' . $p['nama'], 'Edit'); ?></td>
												<td><?php echo anchor('crud/hapususer/handi/17081010012/' . $p['nama'], 'Hapus'); ?>
												</td>
											</tr>
										<?php
										}
